...
class DoctorController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('doctors.index',compact('Patient','statusArr'));
    }
    ...
    public function create()
    {
        ...
        //rahul start code//
        $patients = $this->doctorRepository->getPatients();
        //rahul end code also change in line no 84//
        $doctorsDepartments = getDoctorsDepartments();
        $bloodGroup = getBloodGroups();

        return view('doctors.create', compact('doctorsDepartments', 'bloodGroup','patients'));
    }

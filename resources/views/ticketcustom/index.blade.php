...
@section('content')
    ...
    <div class="card">
            ...
            <div class="card-toolbar">
                <div class="d-flex align-items-center py-1">
                    ...
                    <div
                        ...
                        <a href="{{ route('ticketcustom.create') }}"
                               class="menu-link px-5">{{ __('Add Ticket') }}</a>
                        </div>
                        <div class="menu-item px-5">
        ...
        <div class="card-body pt-0 fs-6 py-8 px-8  px-lg-10 text-gray-700">
                <table class="table table-responsive-sm align-middle table-row-dashed fs-6 gy-5 dataTable no-footer w-100" id="tickettb" >
            <thead>
            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <tr class="border-top border-light">
                                    ...
                                    <td>{{ $item->ticket_by }}</td>
                                        <td>{{ $item->ticket_for }}</td>
                                        <td>{{ $item->purpose }}</td>
                                       
                                       
                                        <td>
                                            <!-- <a href="{{ url('/ticket/' . $item->id) }}" title="View Student"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a> -->
                                            <!-- <a href="{{ url('/ticket/' . $item->id . '/edit') }}" title="Edit Student"><i class="fa fa-lg  fa-edit"> </i>Edit</button></a> -->

                                            <a href="{{ url('/ticketcustom/' . $item->id . '/edit') }}">
                                                <button class="btn"><i class="fa fa-lg  fa-edit"></i></button></a>
                                            <form method="POST" action="{{ url('/ticketcustom' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">

                        ...
                        <div class="row gx-10 mb-5">
                                                            ...
                                                            success:function(data){
                                                               if(data)
                                                               {
                                                                $('#p_name').val(data[0].patient_name);
                                                                 // $('#p_name').val(data[0].first_name + ' '+data[0].last_name);
                                ...
                                <div class="form-group mb-5">
                                    <div>
                                        ...
                                        <select style="width:100%;" class="form-control " data-live-search="true" name="doctorname" id="doctorname" required>
                                            ...
                                            <option value="{{ $items->id }}" {{$counseller->doctorname == $items->id ? 'selected' : ''}}>{{ $items->id }} - {{$items->full_name}}</option>
                                            @endforeach
                                        </select>
                                        <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.5/js/select2.min.js"></script>
                                        <script type="text/javascript">
                            ...
                            <div class="col-md-3 ">
                                <div class="form-group mb-5">
                                    ...
                                    <input type="text" class="form-control diagosis" name="diagosis" id="diagosis"  value="{{old('diagosis',$counseller->diagosis)}}" readonly >
                                </div>
                            </div>  
                            ...
                            <div class="col-md-3 pe-0 mt-5">
                                <div class="form-group mb-5">
                                    ...
                                    <input type="text" class="form-control d_advice" id="d_advice" name="d_advice" value="{{old('d_advice',$counseller->d_advice)}}" readonly >
                                </div>
                            </div> 
                            ...
                            <div class="row mt-5" style="margin-left: 0.001rem;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-lg-1" style="border: 1px solid #a9a5a5;">
                                                    <div class="form-group">
                                                        <select class="form-control " data-live-search="true" name="sutg_cate[]" id="sutg_cate" onchange="fetchsergerycat(<?php echo $i; ?>)" id="sutg_cate<?php echo $count?>" required >
                                               ...
                                               function fetchsergerycat(count_numss){
                                                ...
                                                <td class="col-lg-1" style="border: 1px solid #a9a5a5;">
                                                    <div class="form-group">
                                                        <select class="form-control" class="products" name="products[]"  id="products<?php echo $count; ?>">
                                                ...
                                                <td class="col-lg-1" style="border: 1px solid #a9a5a5;">
                                                    <div class="form-group">
                                                        ...
                                                        <input  style="margin:0 0rem 0 0.3rem; width: 94%;" type="text" class="form-control pk_price" name="pk_price[]" id="pk_price<?php echo $count; ?>" placeholder="Enter"  value="{{$packageprice[$i]}}"  />
                                                    </div>
                                                </td>
                                                ...
                                                <td class="col-lg-1" style="border: 1px solid #a9a5a5;">
                                                    <div class="form-group">
                                                        <select class="form-control" class="p_type" name="p_type[]"  id="p_type<?php echo $count; ?>"> 
                                                ...
                                                <td class="col-lg-1" style="border: 1px solid #a9a5a5;">
                                                    <div class="form-group">
                                                        <select class="form-control" class="bed" name="bed[]"  id="bed">
                                                ...
                                                <td class="col-lg-1" style="border: 1px solid #a9a5a5;">
                                                    <div class="form-group">
                                                        <input style="margin:0 0rem 0 0.3rem; width: 94%;" type="date" class="form-control s_date" id="s_date" name="s_date[]"  value="{{$dos[$i]}}" placeholder="Date Of surgery"  />
                                                        <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.5/js/select2.min.js"></script>
                                                        <script type="text/javascript">
                                                            width: '100%',
                                                            $("#s_date").select2({ });
                                                ...
                                                <td class="col-lg-1" style="border: 1px solid #a9a5a5;">
                                                    <div class="form-group">
                                                        <select style="width:97%;" class="form-control" class="s_status" name="s_status[]"  id="s_status">
                                                            <?php foreach($counseller as  $val_member)?>
                                                ...
                                                <td class="col-lg-1" style="border: 1px solid #a9a5a5;">
                                                    <div class="form-group" style="width: 94%;">
                                                        <input style="margin:0 0 0 0.3rem; width: 94%;" type="text" class="form-control s_date" id="remark" name="remark[]" placeholder="Remark" value="{{$remark[$i]}}"  />
                                                    </div>
                                                </td>

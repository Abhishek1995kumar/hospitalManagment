    ...
    <div class="d-flex flex-column flex-lg-row">
        <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
            ...
            <div class="card">
                ...
                <form action="{{url('pharmareturn/add')}}" method="post" id="addpharama" name="addpharama">
                    @csrf
                        <div class="row gx-10 mb-5">
                            <div class="col-md-6">
                                        <div class="form-group mb-5">
                                            ...
                                            <input type="date" class="form-control" name="accdate" value="{{old('accdate')}}">
                                        </div>
                            </div>
                            <div class="col-md-6">
                                        <div class="form-group mb-5">
                            ...
                            <div class="col-md-6">
                                        <div class="form-group mb-5">
                                            ...
                                            <input type="text" class="form-control" name="billno" value="{{old('billno')}}">
                                        </div>
                            </div>
...
//         // e.target.closest("tr").children[7].textContent = productQty * proRate;
                            ...
                            <div class="row" style="margin-top: 10px;">
                                ...
                                <div class="col-md-3 form-group ttlamts">
                                    <input type="text" class="form-control ttlamt"  name="ttlamt"  id="ttlamt" style="float:right;" readonly/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">

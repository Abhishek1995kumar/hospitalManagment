...
@section('content')
    ...
    <div class="card">
                ...
                <div class="d-flex align-items-center py-1">
                    ...
                    <div
                        ...
                        <a href="{{ url('feedback/create') }}"
                               class="menu-link px-5">{{ __('Add Feecback') }}</a>
                        </div>
                        <div class="menu-item px-5">
        ...
        <div class="card-body pt-0 fs-6 py-8 px-8  px-lg-10 text-gray-700">
                <table class="table table-responsive-sm align-middle table-row-dashed fs-6 gy-5 dataTable no-footer w-100" id="patientfeedbacktb">
            <thead>
            ...
            <th>Patient Name</th>
                                ...
                                @foreach($feedback as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->mobile }}</td>
                                        <td>
                                            <!-- <a href="{{ url('/feedback/' . $item->id) }}" title="View Student"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/feedback/' . $item->id . '/edit') }}" title="Edit Student"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> -->

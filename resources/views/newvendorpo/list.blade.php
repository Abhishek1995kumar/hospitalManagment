...
@section('content')
    ...
    <div class="card">
            ...
            <div class="card-toolbar">
                <div class="d-flex align-items-center py-1">
                    ...
                    <div
                        ...
                        <a href="{{ url('newvendorpo/add_page') }}"
                               class="menu-link px-5">{{ __('Add Vendor Po') }}</a>
                        </div>
        ...
        <div class="card-body pt-0 fs-6 py-8 px-8  px-lg-10 text-gray-700">
                <table class="table table-responsive-sm align-middle table-row-dashed fs-6 gy-5 dataTable no-footer w-100" id="newvendortb">
            <thead>
            ...
            <tr class="border-top border-light">
                                        ...
                                        <td>
                   @if($id == 1)
                    <select name="status" class="status" id="{{ $item->id }}" class="form-control">
                    <option>--Select Status-- </option>
                        <option  <?php echo $item->status == 'Approve' ?  "selected" : "" ?> value="0">Approve</option>
                        <option <?php echo $item->status == 'Deny' ?  "selected" : "" ?> value="1">Deny</option>
                    </select>
                    @else
                        {{$item->status}}
                   @endif
                ...
                <td>
                        <a href="{{url('/newvendorpo/delete/')}}/{{$item->id}}">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Vendor Po</h5>
                            ...
                            <div class="row">
                                ...
                                <table class='table' style='width:91%;margin:0 auto;border-color: black' frame="box">
                                    ...
                                    <td style="border:solid black;border-width:0px 0px 0px 0px;">
                                            <p><strong>PO NO :</strong> <span id="venpo_no"></span></p>
                                        </td>
                                    <td style="border:solid black;border-width:0px 0px 0px 0px;"> 
        ...
        $.ajax({
            ...
            success :function(response){
                ...
                if(response.status == "success"){
                   ...
                   let itemamount_array = response.data[0].cost.split(",");
                   let count = pro_array.length;
                    ...
                    for(let i=0; i<pro_array.length; i++){
                        let html_row = `   <tr>
                            ...
                            <td  class='text-center' style="border:solid black;border-width:1px 1px 1px 1px;">
                                <span id="pr_name">${pro_array[i]}</span></p>                   
                            </td>
                            <td class='text-center' style="border:solid black;border-width:1px 1px 1px 1px;">
                                <span id="hsncode">${hsncode_array[i]}</span></p>     
                            </td>
                            <td class='text-center' style="border:solid black;border-width:1px 1px 1px 1px;">
                                <span id="hsncode">${mrp_array[i]}</span></p>     
                            </td>
                            <td  class="text-center" style="border:solid black;border-width:1px 1px 1px 1px;">
                                <p><span id="qty">${qty_array[i]}</span></p>   
                            </td>	
                            <td class='text-center' style="border:solid black;border-width:1px 1px 1px 1px;">
                                <span id="mrp">${itemamount_array[i]}</span></p>       
                            </td>

...
@section('content')
    ...
    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Location Master Records </h1>
            </div>
                ...
                <div class="d-flex align-items-center py-1">
                    ...
                    <div
                        ...
                        <a href="{{route('location.add')}}"
                               class="menu-link px-5">{{ __('Add Location') }}</a>
                        </div>
                        <div class="menu-item px-5">
                       
                               <a href="{{ route('export-location') }}"   class="menu-link px-5">Export Location</a>
        ...
        <table class="table table-responsive-sm align-middle table-row-dashed fs-6 gy-5 dataTable no-footer w-100" id="loctb">
            <thead>
                                ...
                                @foreach($location as $item)
                                    <tr  class="border-top border-light" >
                                        ...
                                        <td>
                                                 ...
                                                 <a href="{{url('/location/edit/')}}/{{$item->id}}">
                        <button class="btn   "><i class="fa fa-lg  fa-edit"></i></button>
                        </a>
 
                                            <a href="{{url('/location/delete/')}}/{{$item->id}}">

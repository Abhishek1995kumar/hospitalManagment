...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('category/'.$categ->cat_id) }}" method="post">
        <input type="hidden" name="cat_id" value="{{$categ->cat_id}}">
        {!! csrf_field() !!}
        @method("PATCH")
        ...
        <input type="text" name="category_name" id="category_name" value="{{$categ->cat_name}}" class="form-control"></br>

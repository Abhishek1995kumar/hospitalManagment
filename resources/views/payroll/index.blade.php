    ...
    <div class="card">
        <div class="card-header border-0 pt-6">
            ...
            <form action="{{ route('payroll.index') }}" method="post">
                 {!! csrf_field() !!}
                            <table class="table table-responsive-sm align-middle table-row-dashed fs-6 gy-5 dataTable no-footer w-100 id="previousTables">
                                <thead>
                                ...
                                <tbody class="text-gray-600 fw-bold">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->status }}</td>
                                        <td>
                                            <a href="{{ url('/payroll/' .$item->id . '/edit') }}"><button class="btn"><i class="fa fa-lg  fa-edit"></i></button></a> 
                                            <form method="POST" action="{{ url('/payroll' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}

    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Edit Attendance Master</h1>
            </div>
        ...
        <div class="form-group row">
          ...
          <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Employee Name :</label>
           ...
           <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Shift Start :</label>
              <input type="time" name="shift_start" id="shift_start" class="form-control" value="{{$attendance->shift_start}}">
          </div>  
        </div></br>
       <div class="form-group row">
          <div class="col-sm-4">
          <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Shift End :</label>
              <input type="time" name="shift_end" id="shift_end" class="form-control" value="{{$attendance->shift_end}}">
          </div>
           <div class="col-sm-4">
           <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Tea Break:</label>
              <input type="time" name="tea_break" id="tea_break" class="form-control" value="{{$attendance->tea_break}}">
          </div>
           <div class="col-sm-4">
           <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Tea Break Out:</label>
              <input type="time" name="tea_break_out" id="tea_break_out" class="form-control" value="{{$attendance->tea_break_out}}">
          </div>  
        </div><br>
        <div class="form-group row">
          <div class="col-sm-4">
          <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Lunch Break:</label>
            <input type="time" name="lunch_break" id="lunch_break" class="form-control" value="{{$attendance->lunch_break}}">
          </div>
           <div class="col-sm-4">
           <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Lunch Break Out:</label>
              <input type="time" name="lunch_break_out" id="lunch_break_out" class="form-control" value="{{$attendance->lunch_break_out}}">
          </div>
           <div class="col-sm-4">
           <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Meeting Break:</label>
              <input type="time" name="meeting_break" id="meeting_break" class="form-control" value="{{$attendance->meeting_break}}">
          </div>
        </div><br>
        ...
        <div class="form-group row">
          ...
          <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Meeting Break Out:</label>
              <input type="time" name="meeting_break_out" id="meeting_break_out" class="form-control" value="{{$attendance->meeting_break_out}}">
          </div>
          <div class="col-sm-4">

...
@section('content')
    ...
    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Counseller Entry Records </h1>
            </div>
            ...
            <div class="card-toolbar">
                <div class="d-flex align-items-center py-1">
                    ...
                    <div
                        ...
                        <a href="{{ route('counseller.create') }}"
                               class="menu-link px-5">{{ __('Add Counseller Entry') }}</a>
                        </div>
        ...
        <div class="card-body pt-0 fs-6 py-8 px-8  px-lg-10 text-gray-700">
                <table class="table table-responsive-sm align-middle table-row-dashed fs-6 gy-5 dataTable no-footer w-100" id="counsoletb">
                    <thead>
                    ...
                    @foreach($counsaledata as $data)
                    <tr class="border-top border-light">
                    <td style="display:none">{{$data->id}}</td>
                    <td> {{'Patient_00'.$data->ref_patient_id.''}}</td>
                    <td>{{$data->p_name}}</td>
                    ...
                    <td>
                                ...
                                <a href="{{url('/counseller/edit/')}}/{{$data->id}}">

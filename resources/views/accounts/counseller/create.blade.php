                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered text-center" id="itemTable" style="border: 1px solid grey;width:150vw;" >
                                            ...
                                            <tr>
                                                ...
                                                <td style="border: 1px solid #a9a5a5;">
                                                    <div class="form-group">
                                                        <select class="form-select" class="products" name="products[]"  id="products">
                                                ...
                                                <td style="border: 1px solid #a9a5a5;">
                                                    <div class="form-group">
                                                    <input type="text" class="form-control pk_price" name="pk_price[]" id="pk_price" placeholder="Enter"  />
                                                ...
                                                <td style="border: 1px solid #a9a5a5;">
                                                    <div class="form-group">
                                                    <select class="form-select" class="p_type" name="p_type[]"  id="p_type">

...
@section('content')
    ...
    <div class="card">
            ...
            <div class="card-toolbar">
                <div class="d-flex align-items-center py-1">
                    ...
                    <div
                        ...
                        <a href="{{ route('vendorreg.create') }}"
                               class="menu-link px-5">{{ __('messages.vendorreg') }}</a>
                        </div>
                        <div class="menu-item px-5">
        ...
        <div class="card-body pt-0 fs-6 py-8 px-8  px-lg-10 text-gray-700">
                <table class="table table-responsive-sm align-middle table-row-dashed fs-6 gy-5 dataTable no-footer w-100" id="vendorregtb">
                    <thead>
                    ...
                    <td>
                                <a href="{{url('/vendorreg/edit/')}}/{{$data->vendor_id}}">
                                    <button class="btn "><i class="fa fa-lg  fa-edit"></i></button>
                                </a>
                                <a href="{{url('/vendorreg/delete/')}}/{{$data->vendor_id}}">

        ...
        <div class="modal-dialog modal-lg">
         ...
         <div class="form-group row" style="text-align:left;">&nbsp;&nbsp;              
            <div class="form-group col-sm-10">
                ...
                <input type="text" class="form-control secid" id="patient_full_name"  name="secid" readonly>
            </div>
        </div><br>
        <div class="form-group row" style="text-align: left;">&nbsp;&nbsp;
             <div class="form-group col-sm-10">
                 <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Payment Receipt No :</label>
                 <input type="text" class="form-control  paymentname" id="paymentname" value=""  name="paymentname" readonly/>
            </div>
        </div><br>
        <div class="form-group row" style="text-align:left;">&nbsp;&nbsp;    
            <div class="form-group col-sm-10">
                <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Amount:</label>
                <input type="text" class="form-control  paymentamount" id="paymentamount"  name="paymentamount" value="" readonly/>
            </div>
        </div><br>
        <div class="form-group row" style="text-align:left;">&nbsp;&nbsp;      
            <div class="form-group col-sm-10">
                 <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Date:</label>
                 <input type="text" class="form-control  paymentdate" id="paymentdate"  name="paymentdate" value="" readonly/>
            </div> 
        </div><br><br>    
        <div class="form-group row" style="text-align: left;">
            <div class="col-sm-12">
                <tr>&nbsp;&nbsp;
                        ...
                        <tr>&nbsp;&nbsp;
                        <td style="border:solid black;border-width:0px 0px 0px 0px;text-align: left;">
                                <strong style="">Reporting Time:</strong>
                                <span id="timing"></span>
                        </td>
                    </tr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <td  style="border:solid black;border-width:0px 0px 0px 0px;text-align: right;">
                        <strong style="">Authorised Signature</strong>
                    </td>
                </tr>
            </div>
        </div>

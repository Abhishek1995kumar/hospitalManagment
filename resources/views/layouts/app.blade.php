...
<head>
    ...
    @if(getLoggedInUser()->thememode)
        ...
        <link href="{{ mix('assets/css/dark-custom.css') }}" rel="stylesheet" type="text/css"/>
    @endif
</head>
<body id="kt_body"
      class="{{ getLoggedInUser()->thememode ? "dark-mode" : ''}} header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed"
...
<script src="{{ asset('backend/js/datatables.js') }}" defer></script>

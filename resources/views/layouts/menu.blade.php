...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('masterrole*') ? 'active' : '' }}"
       href="{{ route('masterrole') }}">
        <span class="menu-icon"><i class="fas fa-file-invoice"></i></span>
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('ticketcustom*') ? 'active' : '' }}"
       href="{{ route('ticketcustom.index') }}">
        <span class="menu-icon"><i class="fas fa-file-invoice"></i></span>
        <span class="menu-title">{{ __('Tiket Custom') }}</span>
    </a>
</li>
</div>
@endmodule -->
...
@module('Accountants',$modules)
<div class="menu-item side-menus">
    <a class="menu-link menu-text-wrap {{ Request::is('ticket*') ? 'active' : '' }}" href="{{ route('ticket.index') }}">
        <span class="menu-icon"><i class="fa fa-user-nurse"></i></span>
        <span class="menu-title">{{ __('Common Master') }}</span>
    </a>
</div>
@endmodule
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('export_csv*') ? 'active' : '' }}"
       href="{{ route('export_csv') }}">
        <span class="menu-icon"><i class="fas fa-file-invoice"></i></span>
        <span class="menu-title">{{ __('Report Data') }}</span>
    </a>
</li>
</div>
@endmodule 
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('product*') ? 'active' : '' }}"
       href="{{ route('product.index') }}">
        <span class="menu-icon"><i class="fas fa-file-invoice"></i></span>
        <span class="menu-title">{{ __('Product Master') }}</span>
    </a>
</li>
</div>
@endmodule 
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('vendorreg*') ? 'active' : '' }}"
       href="{{ route('vendorreg') }}">
        <span class="menu-icon"><i class="fas fa-file-invoice"></i></span>
        <span class="menu-title">{{ __('Supply Chain') }}</span>
    </a>
</li>
</div>
@endmodule
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('hospitalinvoice*') ? 'active' : '' }}"
       href="{{ route('hospitalinvoice.index') }}">
        <span class="menu-icon"><i class="fas fa-file-invoice"></i></span>
        <span class="menu-title">{{ __('Transaction Master') }}</span>
    </a>
</li>
</div>
@endmodule 
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('analysisdoctor*') ? 'active' : '' }}"
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('counseller*') ? 'active' : '' }}"
       href="{{ route('counseller') }}">
        <span class="menu-icon"><i class="fas fa-file-invoice"></i></span>
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('radiology-categories*') ? 'active' : '' }}"
       href="{{ url('radiology-categories') }}">
        <span class="menu-icon"><i class="fas fa-file-invoice"></i></span>
        <span class="menu-title">{{ __('Lab') }}</span>
    </a>
</li>
</div>
@endmodule
...
{{-- Settings --}}
<div class="menu-item menu-accordion side-menus">
    <a class="menu-link menu-text-wrap {{ Request::is('settings*','hospital-schedules*') ? 'active' : '' }}"
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('attendance*') ? 'active' : '' }}"
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('contact*') ? 'active' : '' }}"
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('ticket*') ? 'active' : '' }}"
       href="{{ route('ticket.index') }}">
        <span class="menu-icon"><i class="fas fa-file-invoice"></i></span>
        <span class="menu-title">{{ __('Ticket List') }}</span>
    </a>
</li>
</div>
@endmodule  -->
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('advanced-payments*') ? 'active' : '' }}"
       href="{{ route('advanced-payments.index') }}">
        <span class="menu-icon"><i class="fas fa-file-invoice"></i></span>
        <span class="menu-title">{{ __('Advanced Payments ') }}</span>
    </a>
</li>
</div>
@endmodule  -->
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('paymentadv*') ? 'active' : '' }}"
       href="{{ route('paymentadv') }}">
        <span class="menu-icon"><i class="fas fa-file-invoice"></i></span>
        <span class="menu-title">{{ __('Advanced Payments ') }}</span>
    </a>
</li>
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('pharma*') ? 'active' : '' }}"
       href="{{ route('pharma') }}">
        <span class="menu-icon"><i class="fas fa-file-invoice"></i></span>
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('pharmareturn*') ? 'active' : '' }}"
       href="{{ route('pharmareturn') }}">
        <span class="menu-icon"><i class="fas fa-file-invoice"></i></span>
        <span class="menu-title">{{ __('Pharmacy Bill Return') }}</span>
    </a>
</li>
</div>
@endmodule  -->
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('leave*') ? 'active' : '' }}"
       href="{{ url('leave') }}">
        <span class="menu-icon"><i class="fas fa-file-invoice"></i></span>
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('tpamaster*') ? 'active' : '' }}"
...
<div class="menu-item side-menus">
    <li>
    <a class="menu-link menu-text-wrap {{ Request::is('feedback*') ? 'active' : '' }}"
...
@if ($billingMGT)
    <div class="menu-item menu-accordion side-menus">
        <a class="menu-link menu-text-wrap {{ Request::is('accounts*','employee-payrolls*','invoices*','payments*','payment-reports*') ? 'active' : '' }}"
           href="{{ $billingMGT }}">

...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('users*','leave*','allow_leave*','attendance*','payrollmaster*')) ? 'd-none' : '' }}"
     id="#kt_header_menu" data-kt-menu="true">
    @role('Admin')
    ...
    <div class="menu-item me-lg-1 {{ Request::is('leave*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('leave') }}">
    ...
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('allow_leave*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('allow_leave') }}">
            <span class="menu-title">{{ __('Allow Leave') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
    ...
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('attendance*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('attendance') }}">
    ...
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('payrollmaster*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('payrollmaster') }}">
            <span class="menu-title">{{ __('Payroll Master') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('analysisdoctor*','counseller*','preot*','postot*')) ? 'd-none' : '' }}"
     id="#kt_header_menu" data-kt-menu="true">
    @role('Admin')
    <div class="menu-item me-lg-1 {{ Request::is('users*') ? 'show' : ''  }}">
        <a class="menu-link py-3 "
           href="{{ route('analysisdoctor') }}">
            <span class="menu-title">{{ __('Doctor Analysis') }}</span>
        </a>
    </div>
    @endrole
    ...
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('counseller*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('counseller') }}">
            <span class="menu-title">{{ __('Counsellor Entry') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
    ...
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('preot*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('preot') }}">
            <span class="menu-title">{{ __('Pre OT') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
    ...
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('postot*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('postot') }}">
            <span class="menu-title">{{ __('Post OT') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('accounts*','employee-payrolls*','invoices*','payments*','payment-reports*')) ? 'd-none' : '' }}"
     id="#kt_header_menu" data-kt-menu="true">
...
<div
    class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('bed-types*','beds*','bulk-beds','bed-status')) ? 'd-none' : '' }}"
    id="#kt_header_menu" data-kt-menu="true">
    @role('Admin|Nurse')
...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('patients*','patient-cases*','case-handlers*','patient-admissions*','feedback*')) ? 'd-none' : '' }}"
    id="#kt_header_menu" data-kt-menu="true">
    ...
    @role('Admin|Receptionist|Doctor|Case Manager')
    @module('Patient Admissions',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('feedback*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ route('feedback.index') }}">
            <span class="menu-title">{{ __('Patient Feedback Form') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('product*','category*','subcategory*','tpamaster*')) ? 'd-none' : '' }}"
    id="#kt_header_menu" data-kt-menu="true">
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('product*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('product') }}">
            <span class="menu-title">{{ __('messages.productss') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
    ...
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('category*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('category') }}">
            <span class="menu-title">{{ __('Categroy') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
    ...
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('subcategory*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('subcategory') }}">
    ...
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('tpamaster*') ? 'show' : '' }}">
        <a class="menu-link py-3"
        href="{{ route('tpamaster.index') }}">
            <span class="menu-title">{{ __('TPA Master') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
    ...
    <!-- <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('leave*','allow_leave')) ? 'd-none' : '' }}"
    id="#kt_header_menu" data-kt-menu="true">
...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('masterrole*','location*')) ? 'd-none' : '' }}"
    id="#kt_header_menu" data-kt-menu="true">
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('masterrole*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('masterrole') }}">
    ...
    <!-- @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('productpo*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('productpo') }}">
            <span class="menu-title">{{ __('Product Po') }}</span>
        </a>
    </div>
    @endmodule
    @endrole -->
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('location*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('location') }}">
            <span class="menu-title">{{ __('Location Master') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('vendorreg*','newvendorpo*','newproduct*')) ? 'd-none' : '' }}"
    id="#kt_header_menu" data-kt-menu="true">

    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('vendorreg*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('vendorreg') }}">
            <span class="menu-title">{{ __('Vendor Registration') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
    ...
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('newvendorpo*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('newvendorpo') }}">
            <span class="menu-title">{{ __('Vendor Po') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
    ...
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('newproduct*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('newproduct') }}">
            <span class="menu-title">{{ __('New Product Po') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('hospitalinvoice*','paymentadv*','ipds*','securitydeposite*','pharma*')) ? 'd-none' : '' }}"
    id="#kt_header_menu" data-kt-menu="true">

    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('hospitalinvoice*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('hospitalinvoice') }}">
            <span class="menu-title">{{ __('Hospital Invoice') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
    ...
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('paymentadv*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('paymentadv') }}">
            <span class="menu-title">{{ __('Advanced Payment') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
    ...
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('securitydeposite*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('securitydeposite') }}">
            <span class="menu-title">{{ __('Security Deposit') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
    ...
    @role('Admin')
    @module('Accountants',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('pharma*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ url('pharma') }}">
            <span class="menu-title">{{ __('Pharmacy Bill') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('ambulances*','ambulance-calls*','lab-technicians')) ? 'd-none' : '' }}"
    id="#kt_header_menu" data-kt-menu="true">
    <!-- @role('Admin|Receptionist')
...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('doctors*','nurses*','doctor-departments*','schedules*')) ? 'd-none' : '' }}"
     id="#kt_header_menu" data-kt-menu="true">
    @role('Admin|Receptionist')
    @module('Doctors',$modules)
...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('ticket*','contact*','appointments*')) ? 'd-none' : '' }}"
    id="#kt_header_menu" data-kt-menu="true">
    @role('Admin')
    @module('Appointments',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('ticketcustom*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ route('ticketcustom.index') }}">
    ...
    @role('Admin')
    @module('Appointments',$modules)
    <div class="menu-item me-lg-1 {{ Request::is('contact*') ? 'show' : '' }}">
        <a class="menu-link py-3"
           href="{{ route('contact.index') }}">
            <span class="menu-title">{{ __('Live Patients') }}</span>
        </a>
    </div>
    @endmodule
    @endrole
...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('radiology-categories*','radiology-tests*','pathology-categories*','pathology-tests*')) ? 'd-none' : '' }}"
    id="#kt_header_menu" data-kt-menu="true">
    @role('Admin|Receptionist')
...
<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch {{ (!Request::is('diagnosis-categories*','patient-diagnosis-test*','enquiries*','enquiry*')) ? 'd-none' : '' }}"
    id="#kt_header_menu" data-kt-menu="true">

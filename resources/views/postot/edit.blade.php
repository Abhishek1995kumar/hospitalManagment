    ...
    <div class="d-flex flex-column flex-lg-row">
        <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
            ...
            <div class="card">
                ...
                <option readonly value="{{$items->id}}" {{$postot->post_mr_no == $items->id  ? 'selected' : ''}}>{{'( Patient_00'.$items->id.')'}}</option>
                 @endforeach
                                         </select> -->


                                         <input type="text" readonly name="post_mr_no" id="post_mr_no" class="form-control" onchange="fetchpostot()"  value="{{'( Patient_00'.$items->id.')'}}"{{$postot->post_mr_no == $items->id  ? 'selected' : '' }}>
                                  </div>
                            </div>
<!--script for patient id through patient name-->
                        ...
                        <!--script end  for patient id through patient name-->
                            ...
                            <div class="col-md-3">
                                        <div class="form-group mb-5">
                                            ...
                                            <input type="text" class='form-control' name="post_patient_name"  id="post_patient_name" value="{{$postot->post_patient_name}}" readonly >  
                                           </div>
                            </div>
                ...
                <option value="{{$items->id}}" {{$postot->post_surgeon_name == $items->id  ? 'selected' : ''}}>{{$items->full_name}}</option>
                @endforeach
                </select>
                ...
                <option value="{{$items->id}}" {{$postot->post_nurse_name == $items->id  ? 'selected' : ''}}>{{$items->full_name}}</option>
                @endforeach
                    </select>
                 </div>
             </div>
                            ...
                            <!-- <div class="col-md-3">
                              ...
                              <div class="col-md-3">
                                ...
                                <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Date:</label>
                                 <input type="date" class="form-control billdate" name="post_date" id="post_date" value="{{$postot->post_date}}" readonly>
                             </div>
                            </div>
                         <hr>
  ...
  <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <table class="table table-striped table-bordered text-center" id="itemedetails" style="border: 1px solid grey;">
                                        ...
                                        <?php
                                        $test_details = explode(",", $postot['post_detailsrange']);
                                        $test_remark = explode(",", $postot['post_details_remark']);
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #a9a5a5;">
                                                ...
                                                <select name="post_detailsrange[]" id="post_detailsrange" class="form-control" readonly>
                                    <option value="">--Select--</option>
                                  
                                    <?php foreach($postdetail as  $items)?>

                                <!-- <option value="{{ $items->detail }}">{{$items->detail}}</option> -->
                                <?php echo '<option value="'.$test_details[$i].'" selected>'.$test_details[$i].'</option>'; ?> 
           ...
           $("#detaismodal").modal('show');
                                            ...
                                            <td style="border: 1px solid #a9a5a5;">
                                                <div class="form-group">
                                                <input type="text" class="form-control post_details_remark" name="post_details_remark[]" id="post_details_remark"  readonly value="{{$test_remark[$i]}}" readonly><br>
                                                </div>
                                            </td>
                                         </tr>
                                         <?php 
  ...
  <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <table class="table table-striped table-bordered text-center" id="itememergencydrug" style="border: 1px solid grey;">
                                        ...
                                        <?php
                                        $test_postotdrug = explode(",", $postot['drug']);
                                        $test_remarkdurgpostot = explode(",", $postot['drug_remark']);
                                        for($i = 0; $i < count($test_postotdrug); $i++) {
                                            ?>
                                        <tr>
                                            <td style="border: 1px solid #a9a5a5;">
                                            ...
                                            <td style="border: 1px solid #a9a5a5;">
                                                ...
                                                <?php foreach($postdrug as  $items)?>

                                                <?php echo '<option value="'.$test_postotdrug[$i].'" selected>'.$test_postotdrug[$i].'</option>'; ?> 
           ...
           $("#drugsmodal").modal('show');
                                            ...
                                            <td style="border: 1px solid #a9a5a5;">
                                                <div class="form-group">
                                                <input type="text" class="form-control drug_remark" name="drug_remark[]" id="drug_remark" placeholder="Enter Yes/ No" readonly value="{{$test_remarkdurgpostot[$i]}}"><br>
                                                </div>
                                            </td>
                                         </tr>
                                         <?php 
  ...
  <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <table class="table table-striped table-bordered text-center" id="itemotcomsumable" style="border: 1px solid grey;">
                                        ...
                                        <?php
                                        $productpostot_dt = explode(",", $postot['post_product']);
                                        $quantitypostot_dt = explode(",", $postot['post_quantity']);
                                        $reusablepostot_dt = explode(",", $postot['post_reusable']);
                                        $pricepostot_dt = explode(",", $postot['post_price']);
                                        $tobebilledpostot_dt = explode(",", $postot['post_tobebilled']);
                                        

                                      
                                        // $id = $pharama['id'];
                                    for($i = 0; $i < count($productpostot_dt); $i++) {
                                    ?>
                                        <tr>
                                            <td style="border: 1px solid #a9a5a5;">
                ...
                <option readonly value="{{ $items->id }}"{{$productpostot_dt[$i]== $items->id ? 'selected' : ''}}>{{ $items->product_name}}</option>
                ...
                <?php
                                            ...
                                            <td style="border: 1px solid #a9a5a5;">
                                                <div class="form-group">
                                                <input type="text" class="form-control post_quantity" name="post_quantity[]" id="post_quantity" placeholder="Enter Quantity"  value="{{$quantitypostot_dt[$i]}}" readonly><br>
                                                </div>
                                            </td>

                                            <td style="border: 1px solid #a9a5a5;">
                                                <div class="form-group">
                                                <input type="text" class="form-control post_reusable" name="post_reusable[]" id="post_reusable" placeholder="Enter Reusable" value="{{$reusablepostot_dt[$i]}}"  readonly><br>
                                                </div>
                                            </td>
                                            <td style="border: 1px solid #a9a5a5;">
                                                <div class="form-group">
                                                <input type="text" class="form-control post_price" name="post_price[]" id="post_price" placeholder="Enter Post Price" required  value="{{$pricepostot_dt[$i]}}" readonly ><br>
                                                </div>
                                            </td>

                                            <td style="border: 1px solid #a9a5a5;">
                                                <div class="form-group">
                                                    <select class="form-select" id="post_tobebilled" name="post_tobebilled[]" id="post_tobebilled"  value="{{$tobebilledpostot_dt[$i]}}" readonly>
                                                    <option value="">--Select--</option>
    ...
    $("#addButton_drug").click(function(){
        i++;
                                ...
                                @endforeach
                                            ...
                                            <td style="border: 1px solid #a9a5a5;">
                                                <div class="form-group">
                                                <input type="text" class="form-control drug_remark" name="drug_remark[]" id="drug_remark_${i}" placeholder="Enter Yes/ No" required><br>
                                                </div>
                                            </td>
                          ...
                          <div class="col-md-3">
                                ...
                                <br>
                                        <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Remark:</label>
                                         <input type="text" name="post_incident_remark" id="post_incident_remark" class="form-control" value="{{$postot->post_incident_remark}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <br>
                                        <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Remark:</label>
                                         <input type="text" name="post_otconduct_remark" id="post_otconduct_remark" class="form-control" value="{{$postot->post_otconduct_remark}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <br>
                                        <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Remark:</label>
                                         <input type="text" name="post_doctornote_remark" id="post_doctornote_remark" class="form-control" value="{{$postot->post_doctornote_remark}}">
...
<hr>
                           ...
                           <div class="col-md-3">
                                ...
                                <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">BP:</label>
                                         <input type="text" name="post_bloodpresure" id="post_bloodpresure" class="form-control" value="{{$postot->post_bloodpresure}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">SPO2:</label>
                                         <input type="text" name="post_spotwos" id="post_spotwos" class="form-control" value="{{$postot->post_spotwos}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Heart Rate:</label>
                                         <input type="text" name="post_heartrate" id="post_heartrate" class="form-control" value="{{$postot->post_heartrate}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" class="form-control ocular_history companyname12" id="" name="post_followupdatecoun" name="post_followupdatecoun"  placeholder="" value="<?php echo date('Y-m-d')?>" value="{{$postot->post_followupdatecoun}}">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" class="form-control ocular_history companyname12" id="" name="post_followupdatedoctor" name="post_followupdatedoctor"  placeholder="" value="<?php echo date('Y-m-d')?>" value="{{$postot->post_followupdatedoctor}}" readonly>
                                         </div>
                                        </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="discharge" id="discharge" class="form-control" value="{{$postot->discharge}}" readonly> </div>
                            </div>

                            <div class="col-md-3">
                                <div class="form-group mb-5">
                                <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Dos and Don'ts:</label>
                                         <input type="text" name="doesdonts" id="doesdonts" class="form-control" value="{{$postot->doesdonts}}" readonly>
                                    </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Post Ot Medication:</label>
                                         <input type="text" name="postotmedication" id="postotmedication" class="form-control" value="{{$postot->postotmedication}}" readonly>

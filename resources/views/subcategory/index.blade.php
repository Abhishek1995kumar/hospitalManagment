        ...
        <div class="card-header border-0 pt-6">
                ...
                <div class="d-flex align-items-center py-1">
                    ...
                    <div
                        ...
                        <a href="{{ route('subcategory.create') }}"
                               class="menu-link px-5">{{ __('Add Sub-Category') }}</a>
                        </div>
                        <div class="menu-item px-5">
            ...
            @endif
                    ...
                    <div class="card-body pt-0 fs-6 py-8 px-8  px-lg-10 text-gray-700">
                            <table class="table  table-responsive-sm align-middle table-row-dashed fs-6 gy-5 dataTable no-footer w-100" id="subcat_tt">
                                <thead>
                                ...
                                <tr class="border-top border-light">
                                        ...
                                        <td>{{ $item->category }}</td>
                                        <td>
                                            <a href="{{ url('/subcategory/' . $item->subcat_id . '/edit') }}" title="Edit Student">
                                            ...
                                            <form method="POST" action="{{ url('/subcategory' . '/' . $item->subcat_id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}

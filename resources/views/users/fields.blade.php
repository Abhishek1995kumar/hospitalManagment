<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-6">
        ...
        <!-- <div class="mb-5">
            {{Form::label('add to cart',_('messages.user.cart').':',['class'=>'form-label required fs-6 fw-bolder text-gray-700 mb-3'])}}
            <br> 
            <span class="form-check form-check-custom form-check-solid is-valid form-check-sm" style= height:"120px">
                <label class ="form-label fs-6 fw-bolder text-gray-700 m-3">{{ __('messages.user.yes') }}</label>&nbsp;&nbsp;
                {{ Form::radio('cart', '0', true, ['class' => 'form-check-input', 'tabindex' => '6']) }} &nbsp;
                <label class="form-label fs-6 fw-bolder text-gray-700 m-3">{{ __('messages.user.no') }}</label>
                {{Form:: radio('cart','0',true,['class'=>'form-check-input','tabindex' =>'6'])}}
            </span>
        </div> -->
        ...
        <br>
        <div class="mb-5">
        <!-- <a href="javascript:void(0)" id="fin_yr" >Add</a> -->
        {{ Form::label('Location', __('Location').':', ['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }}
            </br>
             <select id="lname" name="lname" class="form-control form-control-solid location" required multiple="multiple">
                <option>--select location--</option>
                @foreach($locationcateg as $items)
                  <option value="{{$items->id }}">{{$items->lname}}</option>
                @endforeach
                </select>

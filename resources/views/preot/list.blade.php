...
@section('content')
            ...
            <div class="card-toolbar">
                <div class="d-flex align-items-center py-1">
                    ...
                    <div
                        ...
                        <a href="{{ route('preot.add') }}"
                               class="menu-link px-5">{{ __('Add Pre Ot') }}</a>
                        </div>
    ...
    @foreach($preot as $data)
        <tr>
        <td>{{$data->date_pre}}</td>
        <td>{{$data->patientpre_name}}</td>
        <!-- <td>{{$data->doctor_namepre}}</td> -->
        <td>{{$data->df_name}} {{$data->dl_name}}</td>
        <td>{{$data->surgerycategory_pre}}</td>
       
        <td>
                        
                        <a href="{{url('/preot/delete/')}}/{{$data->id}}">
                        <button class="btn"><i class="fa fa-2xs fa-trash"></i></button>
                        </a>
                       
                        <a href="{{url('/preot/edit/')}}/{{$data->id}}">
                        <button class="btn"><i class="fa fa-lg  fa-edit"></i></button>
                        </a>

                        <a href="{{url('/preot/view/')}}/{{$data->id}}">
                        <button class="btn"><i class="fa fa-lg  fa-eye"></i></button>
                        </a>
                       
                        <!-- <a>
                        <button type="button"   class="btn showid"><i class="fa fa-lg  fa-eye"></i></button>
                        </a> -->
                </td>

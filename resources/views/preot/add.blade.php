    ...
    <div class="d-flex flex-column flex-lg-row">
        <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
            ...
            <div class="card">
                ...
                <form action="{{url('preot/add')}}" method="post" id="doctoranalysis" name="doctoranalysis">
                    @csrf
                        ...
                        <option value="{{ $items->id }}">{{$items->first_name}}
                            ...
                            <script>
                             ...
                             <div class="col-md-3">
                                ...
                                <input class='form-control  select2Patient' name="patientpre_name"  id="patientpre_name" >  
                                           </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group mb-5">
                                        <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Mob No :</label>
                                         <input type="text" name="mobile_pre" id="mobile_pre"    class="form-control" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-5">
                                        ...
                                        <input type="text" name="age_pre" id="age_pre" class="form-control" >   
                           ...
                           <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-5">
                                    ...
                                    <option value="">--Surgery Category Type--</option>
                                    <option value="Cataract">Cataract</option>
                                    <option value="Retina">Retina</option>
                                    <option value="Pterygium">Pterygium</option>
                                    <option value="Squint">Squint</option>
                                    <option value="RetinaInjection">Retina Injection</option>
                                    <option value="Chalazion">Chalazion</option>
                                    <option value="Cornea">Cornea</option>
                                    <option value="SOR">SOR</option>
                                    <option value="Vitrectomy">Vitrectomy</option>
                                    <option value="RetinalDetachment">Retinal Detachment</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-5">
                                        <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Package:</label>
                                         <input type="text" name="package_pre" id="package_pre"    class="form-control" required>
...
<hr>
           ...
           $("#testmodal").modal('show');
                     ...
                     <td style="border: 1px solid #a9a5a5;">
                         <div class="form-group">
                         <input type="file" name="uploaed_pre[]" id="uploaed_pre" class="form-control upload_document">
                         <br>
                         </div>
                        </td>
                        </tr>

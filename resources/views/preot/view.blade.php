    ...
    <div class="d-flex flex-column flex-lg-row">
        <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
            ...
            <div class="card">
                ...
                <form action="{{url('preot/view/'.$preot->id)}}" method="post" id="preot" name="preot">
                @csrf
                    @csrf
                        ...
                        <div class="col-md-3">
                                        <div class="form-group mb-5">
                                            ...
                                            <select class="form-select" name="pre_id" id="pre_id" onchange="fetchpatientid()" readonly required>
                 ...
                 @endforeach
                            ...
                            <script>
                             ...
                             <div class="col-md-3">
                                ...
                                <input class='form-control  select2Patient' name="patientpre_name"  id="patientpre_name" readonly value="{{$preot->patientpre_name}}" >  
                                           </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group mb-5">
                                        <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Mob No :</label>
                                         <input type="text" name="mobile_pre" id="mobile_pre"    class="form-control" readonly value="{{$preot->mobile_pre}}"required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-5">
                                        ...
                                        <input type="text" value="{{$preot->age_pre}}" name="age_pre" id="age_pre" readonly  class="form-control" >   
                           ...
                           <div class="col-md-3">
                                ...
                                <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Operating Dr name :</label>
                                    <select class="form-select patientType" id="doctor_namepre" name="doctor_namepre" readonly  required>
             ...
             @endforeach
                            ...
                            <div class="col-md-3">
                                        ...
                                        <input type="date" name="date_pre" value="{{$preot->date_pre}}" id="date_pre" readonly  class="form-control" >   
                                        </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-5">
                                        ...
                                        <select name="eye_pre" id ="eye_pre" readonly  class="form-control">
         ...
         @endforeach
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-5">
                                        ...
                                        <select name="surgerycategory_pre" id ="surgerycategory_pre" readonly class="form-control">
         ...
         @endforeach
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-5">
                                        ...
                                        <select name="type_pre" readonly  id ="type_pre" class="form-control">
         ...
         @endforeach
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-5">
                                        ...
                                        <select name="diabeticstatus_pre" id ="diabeticstatus_pre"  readonly class="form-control">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-5">
                                        <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Package:</label>
                                         <input type="text" name="package_pre" id="package_pre"    class="form-control" readonly  value="{{$preot->package_pre}}" required>
...
<hr>
                                    <table class="table table-striped table-bordered text-center" id="testdetail" style="border: 1px solid grey;">
                                        ...
                                        <option value="Fundus Examination">Fundus Examination</option>
                                            ...
                                            <td style="border: 1px solid #a9a5a5;">
                                                <div class="form-group">
                                                <input type="file" name="uploaed_pre[]" value="{{$preot->uploaed_pre}}" readonly  id="uploaed_pre" class="form-control upload_document">
                                                <br>
                                             </div>
                                            </td>
                                        </tr>
    ...
    $("#addButton_testdetails").click(function(){
        i++;
                                    ...
                                    var html2 =`<tr>
                                            ...
                                            <td style="border: 1px solid #a9a5a5;">
                                                <div class="form-group">
                                                <select class="form-select" onchange="fetchpreotMulti(${i})" name="test_pre[]" readonly  id="test_pre_${i}" "required>
                                                <option value="">--Select Test Type--</option>
                                                @foreach ($test as $item)
                                                <option <?php echo $item->test_pre == 'Diabetic Status' ?  "selected" : "" ?> value="Diabetic Status">Diabetic Status</option>
                                                <option <?php echo $item->test_pre == 'Cardiac Concern' ?  "selected" : "" ?> value="Cardiac Concern">Cardiac Concern</option>
                                        
                                                <option <?php echo $item->test_pre == 'ECG' ?  "selected" : "" ?> value="ECG">Cardiac Concern</option>
                                                <option <?php echo $item->test_pre == 'APHALab Test Required' ?  "selected" : "" ?> value="APHALab Test Required">APHALab Test Required</option>
                                                <option <?php echo $item->test_pre == 'RTPCR' ?  "selected" : "" ?> value="RTPCR">RTPCR</option>
                                                <option <?php echo $item->test_pre == 'HIV' ?  "selected" : "" ?> value="HIV">HIV</option>
                                                <option <?php echo $item->test_pre == 'Hepatitis' ?  "selected" : "" ?> value="Hepatitis">Hepatitis</option>
                                                <option <?php echo $item->test_pre == 'Blood Pressure' ?  "selected" : "" ?> value="Blood Pressure">Blood Pressure</option>
                                                <option <?php echo $item->test_pre == 'A Scan' ?  "selected" : "" ?> value="A Scan">A Scan</option>
                                                <option <?php echo $item->test_pre == 'B Scan' ?  "selected" : "" ?> value="B Scan">B Scan</option>
                                                <option <?php echo $item->test_pre == 'Allergy to Drug' ?  "selected" : "" ?> value="Allergy to Drug">Allergy to Drug</option>
                                                <option <?php echo $item->test_pre == 'OCT' ?  "selected" : "" ?> value="OCT">OCT</option>
                                                <option <?php echo $item->test_pre == 'Syringing' ?  "selected" : "" ?> value="Syringing">Syringing</option>
                                                <option <?php echo $item->test_pre == 'Fundus Examination' ?  "selected" : "" ?> value="Fundus Examination">Fundus Examination</option>
                                            ...
                                            <td style="border: 1px solid #a9a5a5;">
                                                <div class="form-group">
                                                <input type="file" name="uploaed_pre[]" readonly  id="uploaed_pre_${i}" class="form-control upload_document">
                                                <br>
                                             </div>
                                            </td>

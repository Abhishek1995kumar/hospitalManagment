    ...
    <div class="d-flex flex-column flex-lg-row">
        <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
            ...
            <div class="card">
                ...
                <form action="{{url('pharma/add')}}" method="post" id="addpharama" name="addpharama">
                    @csrf
                        ...
                        <div class="col-md-6">
                                        <div class="form-group mb-5">
                                            ...
                                            <input type="date" class="form-control" name="billdate" value="{{old('billdate')}}"> -->

                                            <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Bill Date :</label>
                                            <input type="text" class="form-control billdate" name="billdate" value="<?=date('d-m-Y');?>" readonly>
                                        </div>
                            </div>
                            <div class="col-md-6">
                                        <div class="form-group mb-5">
                                            <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Bill No :</label>
                                             <input type="text" name="bill_no" id="bill_no"   value="PHAR_BILL_{{ $lastId }}"   class="form-control"  readonly>
                                ...
                                <div class="form-group mb-5">
                                        <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Patient Name :</label>
                                            ...
                                            <select class="form-select "  name="pname" id="pname">
                                                <option value="">Select patinet name</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="" class="form-label fs-6 fw-bolder text-gray-700 mb-3">Patient Type :</label>
                                    <select class="form-select patientType" id="patientType" name="patientType">
                                    ...
                                    <table class="table table-striped table-bordered text-center" id="itemTable" style="border: 1px solid grey;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #a9a5a5;">
                                                ...
                                                <select class="form-select" class="products" name="products[]" onchange="fetchProductPrice()" id="products">
                                            ...
                                            <td style="border: 1px solid #a9a5a5;">
                                                <div class="form-group">
                                                <input type="text" class="form-control hsncode" id="hsncode" name="hsncode[]" placeholder="Enter HSN Code"   />
                                                </div>
                                            </td>
                                            <td style="border: 1px solid #a9a5a5;">
                                                <div class="form-group">
                                            ...
                                            <td style="border: 1px solid #a9a5a5;">
                                                <div class="form-group">
                                                    <input type="hidden" id="qty_du">
                                                <input type="text" class="form-control qty editQty" id="qty" onkeyup="qtymanage()" name="qty[]" placeholder="Enter QTY"/>
                                                </div>
                                            </td>
                                            <td style="border: 1px solid #a9a5a5;">
                                                <div class="form-group">
                                                <input type="text" class="form-control itemamount" id="itemamounts" name="itemamount[]" placeholder="Enter Amount"  />
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <script>
                                ...
                                $("#hello").click(function(){
                                    ...
                                    var html = `<tr>
                                                ...
                                                <td style="border: 1px solid #a9a5a5;">
                                                    <div class="form-group">
                                                    <input type="text" class="form-control qty_ editQty" id="qty_${i}" name="qty[]" placeholder="Enter QTY" onkeyup="hd_qtymanage(${i})"/>
                                                    </div>
                                                </td>
                                                <td style="border: 1px solid #a9a5a5;">
                                                    <div class="form-group">
...
function fetchProductPriceMult(milt_i){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            $('#qty_'+milt_i).val(1);
            hd_remaining_pro_qty = data[0].max_qty;
...
function hd_qtymanage(milt_ii)
                                    {
                                        
                                        let hd_salespro_qty = hd_remaining_pro_qty;
                                       var hdqty_id =  $('#qty_'+milt_ii).val();
                                      
                                  
                                    
                                      if(parseInt(hdqty_id) >= parseInt(hd_salespro_qty))
                                     {
                                        alert("Item Quantity "+hdqty_id+" is more than stock Quantity"+hd_salespro_qty);
                                        $('#qty_'+milt_ii).val(hd_salespro_qty);
                                     }
...
//         // e.target.closest("tr").children[7].textContent = productQty * proRate;
                            ...
                            <div class="row" style="margin-top: 10px;">
                                ...
                                <div class="col-md-3 form-group ttlamts">
                                    <input type="text" class="form-control ttlamt" readonly  name="ttlamt"  id="ttlamt" style="float:right;" readonly/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <table class="table table-striped table-bordered text-center" id="itemTablePayementDetails" style="border: 1px solid grey;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #a9a5a5;">
                                                <div class="form-group">
                                                <input type="text" class="form-control" name="amount[]" placeholder="Enter Amount"  onkeyup="updateTotalpaymentAmount()"  >
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                                    ...
                                                    $.ajax({
                                                            ...
                                                            success:function(data){
                                                               if(data)
                                                               {
                                                                ...
                                                                $('#qty').val(1);
                                                                remaining_pro_qty = data[0].max_qty;
                              console.log(remaining_pro_qty);
                                                                
                                                                

                                                                $('#hsncode').val(data[0].hsn_name);
                                                                updateTotalAmount();
                                        ...
                                        <script>
                                             function qtymanage()
                                            {
                                                let salespro_qty = remaining_pro_qty;
                                              var qty_id =  $('#qty').val();
                                              console.log(qty_id);
                                            
                                              if(parseInt(qty_id) >= parseInt(salespro_qty))
                                             {
                                                alert("Item Quantity "+qty_id+" is more than stock Quantity"+salespro_qty);
                                                $('#qty').val(salespro_qty);
                                             }

...
<div class="col-md-6">
        <div class="form-group mb-5">
            <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Patient Id</label>
            <input type="text" name="user_id" id="user_id" value="{{ $new_string }}" class="form-control form-control-solid" readonly>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            {{ Form::label('age', __('Age').':', ['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }}
            {{ Form::text('age', null, ['class' => 'form-control form-control-solid', 'id' => 'birthDate', 'autocomplete' => 'off', 'tabindex' => '4']) }}
        </div>
    </div>

                    ...
                    <div class="row gx-10 mb-5">
                        <div class="col-md-6">
                            <div class="form-group mt-5 mb-5">
                                ...
                                <select style="width:100%;" class="form-control" data-live-search="true"  name="patientsecurity_name" id="patientsecurity_name" required>
                                    ...
                                    <option value="{{ $items->id }}">{{'( Patient_00'.$items->id.')'}} - {{ $items->full_name}}</option>
                                    @endforeach
                                </select>
                                <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.5/js/select2.min.js"></script>
                                <script>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mt-5">
                                ...
                                <input type="text" class="padd form-control  receipt_name" id="receipt_name"  value="Security_Deposit_{{ $lastId }}" name="receipt_name" readonly/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mt-5 mb-5">
                                ...
                                <input type="text" class="padd form-control  subcat" id="ammount_security" name="ammount_security"/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mt-5 mb-5">
                                ...
                                <input style="width:100%;" type="date" class="padd form-control billdate" name="date" id="date">
                            </div>
                        </div>

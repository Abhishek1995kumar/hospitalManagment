    ...
    <div class="main-responsive-nav">
        <div class="container">
            <div class="main-responsive-menu">
                <div class="logo">
                    <a href="{{ url('/') }}">
                        <img src="{{ $settingValue['favicon']['value'] }}" class="favicon-logo" alt="logo">
        ...
        <div class="{{ Request::is('/') ? 'container-fluid' : 'container' }}">
            <nav class="navbar navbar-expand-md navbar-light">
                <a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    <img src="{{('assets/img/logo-red-black.png')}}" class="front-header-logo" alt="logo" style="width:95px;height:45px;" class="image"> 
                </a>

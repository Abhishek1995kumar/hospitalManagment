                                    ...
                                    <div class="form-group">
                                        <select class="doctor-name-filter" name="doctorId">
                                            ...
                                            @foreach($doctors as $doctor)
                                                <option
                                                        value="{{ $doctor->id }}">{{$doctor->full_name}}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                ...
                @foreach($frontServices  as $frontService)
                    <div class="col-lg-3 col-md-6 col-sm-6 our-service-cards">
                        <div class="single-services-card h-100">
                            <div class="image">
                                <img src="{{isset($frontService->icon_url)? (asset('web_front/images/services/').'/'.$frontService->icon) : asset('web_front/images/services/medicine.png')}}" 
                                     alt="image">

                                    <!--<img src="{{('assets/web_front/images/medicine.png')}}" alt="image">-->

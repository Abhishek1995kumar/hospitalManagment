<div class="row">
    ...
    @else
        ...
        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('patient_name', __('messages.case.patient').':', ['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }}<span class="required"></span>
            {{ Form::text('patient_name', null, ['class' => 'form-control form-control-solid', 'required', 'id' => 'firstName','tabindex' => '1']) }}
        </div>
    @endif
